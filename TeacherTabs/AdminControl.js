  ...
  render() {
    ...
    <Text style={styles.TextStyle}>Holidays</Text>
        ...
        <LinearGradient colors={['#36D6BD','#007E7B']} start={{ x:0, y:1}} style={ styles.Linear_G }>
          ...
          <SafeAreaView style={styles.setholidays}>
          <DatePicker style={{ backgroundColor:'#fff', borderRadius: 5}} date={this.state.dateHoliday} format="YYYY-MM-DD" onDateChange={(date) => {this.setState({dateHoliday: date})}}  mode="date" placeholder="select date" />
